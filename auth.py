   ...
   "outputs": [
    {
     ...
     "text": [
      "Enter username:abc\n",
      "Enter password:········\n",
      "Authentication succeeded: {'abc': ['def', 1149, 'eeQPBTSPFd']}\n"
     ]
    }
   ],
   "source": [
    ...
    "        add_user(username, password, hash_val, salt_val, pwdb)\n",
    "\n",
    "    return status\n",
    "\n",
    "def add_user(username, password, hash_val, salt_val, pwdb):\n",
    "    pwdb[username] = [password, hash_val, salt_val]\n",
    "    write_pwdb(pwdb)\n",
    "\n",
    "def read_pwdb():\n",
    "    try:\n",
